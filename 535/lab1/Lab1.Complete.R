...
#February 25, 2025
#
#This is the code for Laboratory #1.  It contains all the commands you
#need to answer the online questions and complete your laboratory written
#report.
#
#In addition to this code you will need the datasets for the Amtrak
#data and for the hierarchical sales data.  These are available
#on Blackboard under the Datasets Used in Laboratories link. 
#
...
#
#First load all the libraries you need for this laboratory.  I have a set
#of libraries that I use for time series analysis and forecasting. Some
#of these will cause conflicts if you change the code.  So watch out for 
#that!  If you start getting errors there could be several reasons for
#that.  It could be a conflict between libraries.  It could be that you
#are using a different version of R or of any of these libraries than I
#have been.  If you do get an error it is best to contact your Instructor
#as soon as possible to resolve it.  There is no reason to spend a lot
#of time and get frustrated.  We are here to help you!
#
...
setwd("/Users/nkohei/Workspace/McDaniel-Repository/535/lab")
...
# setwd("I:/My Passport Documents/McDaniel/DataAnalytics/ANA535/NewANA535/Laboratories/Laboratory1")

#
#Best practices for data analytics says that we should
#conduct some preliminary or exploratory data analysis.
#So, let's do that.
#
...
#time series.  We'll use the ts() command to do that.  
#
...
Amtrak %>% 
  filter(between(Amtrak$Date, as.Date('1999-01-01'), as.Date('1999-12-01')))
...
plot(Amtrak.Miles.ts, xlab = "Time", ylab = "Passenger Miles", bty = "l")
lines(Amtrak.Miles.lm$fitted, lwd = 2)
plot(Amtrak.Miles.ts.zoom, xlab = "Time", ylab = "Ridership", bty = "l")
